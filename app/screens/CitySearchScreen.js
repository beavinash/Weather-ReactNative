...
export default class App extends React.Component {
  constructor(props) {
    ...
    this.state = {
      searchInput: '',
      searchResult: 0,
      error: 'Search for a city...', // to display if search doesnt display results
  ...
  searchCity = () => {
    this.fetchCityTemp(this.state.searchInput) // setting in render and props constructor... :)
  }
  ...
  fetchCityTemp = (city) => {
    ...
    fetch('http://api.openweathermap.org/data/2.5/weather?q='+city+'&appid=616f7c6ebf57cf29940a19c2fbf3c76b&units=imperial')
